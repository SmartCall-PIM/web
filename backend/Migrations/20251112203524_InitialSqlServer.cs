        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TecnicoId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    AtribuidoATecnico = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    criado_em = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_user = table.Column<bool>(type: "bit", nullable: false),
                    AutorId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    TipoAutor = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    chamado_id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
